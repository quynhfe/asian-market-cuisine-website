...
export default function BookingContent() {
 ...
 <Image fill className="object-cover" src={HERO_IMG} alt="Intimate candlelit dining table" />
 </div>
 ...
 <p className="font-headline italic text-lg md:text-xl text-primary">"A quiet ritual of taste and time."</p>
 </div>
 </div>
 </div>
 </section>
 ...
 <div className="lg:col-span-4">
  <h2 className="text-3xl md:text-4xl font-headline italic text-primary mb-4 md:mb-6">The Ritual</h2>
 <p className="text-on-surface/70 mb-8 md:mb-12 text-sm md:text-base">Select your preferred date and time. For parties larger than 6, please contact our concierge directly.</p>
 ...
 <span className="block text-xs font-label uppercase tracking-widest text-on-surface/60 mb-3 md:mb-4">Select Date</span>
 ...
 {/* Time */}
 <div className="md:col-span-2">
 <span className="block text-xs font-label uppercase tracking-widest text-on-surface/60 mb-3 md:mb-4">Time Slot</span>
 ...
 {/* Guests */}
 <div className="md:col-span-2">
 <span className="block text-xs font-label uppercase tracking-widest text-on-surface/60 mb-3 md:mb-4">Number of Guests</span>
 ...
 <label htmlFor="full-name" className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-1">Full Name</label>
 ...
 <label htmlFor="email" className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-1">Email Address</label>
 <input id="email" type="email" placeholder="email@example.com"
 className="w-full bg-transparent border-0 border-b border-outline-variant py-3 focus:ring-0 focus:border-primary placeholder-transparent transition-all outline-none text-sm md:text-base"
 required autoComplete="email" />
 </div>
 <div className="md:col-span-2">
 <label htmlFor="special-request" className="block text-xs font-label uppercase tracking-widest text-on-surface/50 mb-1">Special Occasion or Request</label>
 <textarea id="special-request" rows={2} placeholder="Anniversary, dietary requirements, or preferred seating..."
 ...
 <Image fill className="object-cover" src={ATMOSPHERE_IMG} alt="Interior of a luxury restaurant" />
 </div>
 </div>
  <div className="md:col-span-5 md:pl-8 lg:pl-12">
 <h3 className="text-3xl md:text-4xl lg:text-5xl font-headline italic text-primary mb-5 md:mb-8 leading-tight">A sanctuary of flavor and light.</h3>
 <p className="text-on-surface/70 leading-relaxed mb-6 md:mb-8 text-sm md:text-base">Our space is designed to soothe the senses. From the warmth of reclaimed cedar to the gentle glow of washi paper lamps, every detail prepares you for the journey ahead.</p>
 ...
 <h4 className="text-xs font-label uppercase tracking-widest text-on-surface/50 mb-4 md:mb-6">Reservation Policy</h4>
